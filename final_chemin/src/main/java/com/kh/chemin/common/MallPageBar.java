...
public class MallPageBar {
   ...
   public static String getReviewPageBar(int cPage, int numPerPage, int totalContents)
   {
      String pageBar="";
      int pageBarSize=5;
   ...
   public static String getQnAPageBar(int cPage, int numPerPage, int totalContents)
   {
      String pageBar="";
      int pageBarSize=5;
