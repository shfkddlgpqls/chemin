...
<body>
<br><br>
<form action="${pageContext.request.contextPath}/login/loginCheck.do" method="post" class="signUp" id="signupForm">
   <h1 class="signUpTitle">LogIn</h1>
   <input type="text" class="signUpInput" name="userId" placeholder="Type your username" autofocus required>
   <input type="password" class="signUpInput" name="password" placeholder="Choose a password" required>
